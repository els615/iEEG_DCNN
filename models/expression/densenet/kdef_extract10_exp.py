...
save_dir = '/mmfs1/data/schwarex/neuralNetworks/densenet/retrains/expression/kdef'
#
...
class KDEFDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        label = self.dataAll.iloc[idx,1] #identity labels
...
for rep in range(1,11):
    checkpoint_file = '/mmfs1/data/schwarex/neuralNetworks/densenet/retrains/expression/199_%d.ckpt' % rep
