# extract features of KDEF images from untrained resnet18
import torch
...
save_dir = '/mmfs1/data/schwarex/ieeg/neuralNetworks/untrained/resnet_noSoftmax'
#save_dir = '/Users/emilyschwartz/Desktop/Projects/NeuralNetworks/Untrained/resnet'
...
#df = pd.read_pickle('/Users/emilyschwartz/Desktop/Projects/NeuralNetworks/kdef_5views.pkl')
...
for rep in range(1,2):
    ...
    df2 = pd.DataFrame(list_of_tuples, columns = ['final_output', 'conv1', 'lay1', 'lay2', 'lay3', 'lay4', 'index'])
